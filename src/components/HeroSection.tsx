...
export function HeroSection() {
  return <section className="bg-card rounded-xl p-4 md:p-6 mb-4 shadow-card animate-fade-in">
      <div className="text-center max-w-3xl mx-auto">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-2 animate-fade-in-up">Free AI Image Optimizer for Better SEO<strong>PixelSEO</strong> – Free AI Image Optimizer for <span className="text-primary">Better SEO</span>
        </h1>
