...
export function Footer() {
  ...
  const socialLinks = [
    ...
    { icon: PinterestIcon, href: 'https://pinterest.com/pixelseo', label: 'Pinterest', ariaLabel: 'Follow PixelSEO on Pinterest' },
    { icon: TikTokIcon, href: 'https://tiktok.com/@pixelseo', label: 'TikTok', ariaLabel: 'Follow PixelSEO on TikTok' },
  ];
